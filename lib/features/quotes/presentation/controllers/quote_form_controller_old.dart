...
import 'quote_form_ui_controller.dart';
import '../widgets/quote_form/quote_form_handler.dart';
import '../widgets/dialogs/tax_rate_dialogs.dart';
import '../../../../app/constants/quote_form_constants.dart';

/// Refactored QuoteFormController using clean architecture
...
class QuoteFormController extends ChangeNotifier {
  QuoteFormController({
    ...
    this.roofScopeData,
    this.existingQuote,
  }) : _uiController = QuoteFormUIController.fromContext(
          context: context,
          customer: customer,
  ...
  final QuoteFormUIController _uiController;
