...
class _PdfPreviewScreenState extends State<PdfPreviewScreen>
  ...
  // Key to access the PdfFileOperationsHandler methods
  final GlobalKey<State<PdfFileOperationsHandler>> _fileOpsHandlerKey = GlobalKey();
  ...
  Widget build(BuildContext context) {
    return _fileOpsController.createPdfFileOperationsHandler(
      key: _fileOpsHandlerKey,
      child: Scaffold(
  ...
  Future<void> _savePdf() async {
    ...
    try {
      final handlerState = _fileOpsHandlerKey.currentState;
      if (handlerState != null) {
        await (handlerState as dynamic).savePdf(
          currentPdfPath: _currentPdfPath,
...
// Show share success message
  ...
  Future<void> _sharePdf() async {
    final handlerState = _fileOpsHandlerKey.currentState;
    if (handlerState != null) {
      await (handlerState as dynamic).sharePdf(
        currentPdfPath: _currentPdfPath,
        editedValues: _editingController.editedValues,
        formFields: _formFields,
        suggestedFileName: widget.suggestedFileName,
